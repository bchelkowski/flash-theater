sub Main()
    ...
    ' so the one-time, order-sensitive step of wiring the router (setRouting + the initial
    ' navigate()) lives in a hand-declared `public function setup()` instead, called once here.
    ' Same one-hand-written-line convention as FlashTheaterSetupGlobals above.
    '
